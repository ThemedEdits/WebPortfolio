...
export default function CTASection() {
  ...
  return (
    <section ref={ref as React.RefObject<HTMLElement>} className="py-16 sm:py-28 px-6 sm:px-10 lg:px-16">
      <div className="sec-item max-w-4xl mx-auto text-center" style={{ animationDelay: '0s' }}>
        <div className="relative gradient-border p-1 rounded-2xl sm:rounded-3xl">
          <div className="rounded-2xl sm:rounded-3xl px-6 sm:px-8 py-14 sm:py-20 relative overflow-hidden"
            style={{ background: 'linear-gradient(135deg, #111111, #161616)' }}>
            <div className="orb w-64 h-64 top-1/2 left-1/4 -translate-y-1/2 -translate-x-1/2"
              style={{ background: 'radial-gradient(circle, rgba(245,166,35,0.1) 0%, transparent 70%)' }} />
            <div className="orb w-48 h-48 top-1/2 right-1/4 -translate-y-1/2 translate-x-1/2"
              style={{ background: 'radial-gradient(circle, rgba(255,255,255,0.05) 0%, transparent 70%)' }} />
            <div className="relative z-10">
              <div className="inline-flex items-center gap-2 section-tag mb-5 sm:mb-6">
